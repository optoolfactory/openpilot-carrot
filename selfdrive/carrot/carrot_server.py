...
async def ws_carstate(request: web.Request) -> web.WebSocketResponse:
  ...
  sm = messaging.SubMaster(['carState', 'carControl', 'deviceState', 'longitudinalPlan', 'peripheralState'])
  ...
  try:
    while True:
      ...
      if sm.alive['carState'] and sm.alive['carControl']:
        ...
        apply_speed = 0 #CM.desiredSpeed
        apply_source = 0 #CM.desiredSource
